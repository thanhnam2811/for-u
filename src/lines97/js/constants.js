...
// localStorage keys
export const LS_HIGH = 'lines97_highScore';
export const LS_PALETTE = 'lines97_palette';
export const LS_SOUND = 'lines97_sound';
export const LS_SAVE = 'lines97_save';
export const LS_LEADERBOARD = 'lines97_leaderboard';
export const LS_CHECKPOINT = 'lines97_checkpoint_';
