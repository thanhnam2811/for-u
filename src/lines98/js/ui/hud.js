...
export const hud = {
  ...
  spawnFloatingText(text, row, col, isCombo = false) {
    ...
    // Premium styling
    floatingText.className = `absolute pointer-events-none z-30 font-display font-bold text-xs sm:text-sm text-center -translate-x-1/2 -translate-y-1/2 transition-all duration-1000 ${
      isCombo 
