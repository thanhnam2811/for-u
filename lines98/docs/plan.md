...
> **Slogan:** _"Lines 98 như bạn nhớ, nhưng với game feel mà bạn luôn tưởng tượng nó nên có."_
...
- **Danger Alert:** Quả bóng cờ có nước đi kế tiếp bị chặn bởi spawn tương lai cắt ngang đường cờ (Potential Line Setup) sẽ chuyển màu nhạt đi (desaturate) và rung nhẹ cản trở (`🔴 shake`). _Lưu ý:_ Tránh cảnh báo quá nhiều khi spawn tương lai trùng ô thông thường để giữ độ tư duy tự nhiên cho người chơi.
...
- \*\*Theme Class Contract: Cấu trúc theme hóa được quy chuẩn:
    ...
    ```
    Người chơi tự do chọn các Theme: _Classic CRT_, _Windows 98_, _Crystal_, _Neon Cyber_, _Galaxy Space_, _Zen Garden_.
